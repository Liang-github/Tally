...
//  Tally
//
//  Created by PengLiang on 2017/11/29.
...
- (TallyListView *)listView {
    if (!_listView) {
        ...
        // 记账类型列表
        _listView = [[TallyListView alloc] initWithFrame:CGRectMake(0, 64, self.view.frame.size.width, self.view.frame.size.height - 64 - self.view.frame.size.height*0.4) collectionViewLayout:layout];
